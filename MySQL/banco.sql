...
--
-- Host: 127.0.0.1
-- Tempo de geração: 18/03/2025 às 01:48
...
ALTER TABLE `pedido`
  ...
  ADD KEY `id_produto_pedido` (`id_produto_pedido`),
  ADD KEY `id_fornecedor_pedido` (`id_fornecedor_pedido`);
...
ALTER TABLE `produto`
  ...
  ADD KEY `id_produto_fornecedor` (`id_produto_fornecedor`);
...
--
ALTER TABLE `pedido`
  ADD CONSTRAINT `pedido_ibfk_1` FOREIGN KEY (`id_usuario_pedido`) REFERENCES `usuario` (`id_usuario`) ON DELETE CASCADE,
  ADD CONSTRAINT `pedido_ibfk_2` FOREIGN KEY (`id_produto_pedido`) REFERENCES `produto` (`id_produto`) ON DELETE CASCADE,
  ADD CONSTRAINT `pedido_ibfk_3` FOREIGN KEY (`id_fornecedor_pedido`) REFERENCES `fornecedor` (`id_fornecedor`) ON DELETE CASCADE;

--
-- Restrições para tabelas `produto`
--
ALTER TABLE `produto`
  ADD CONSTRAINT `produto_ibfk_1` FOREIGN KEY (`id_produto_fornecedor`) REFERENCES `fornecedor` (`id_fornecedor`) ON DELETE SET NULL;

--
-- Restrições para tabelas `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `usuario_ibfk_1` FOREIGN KEY (`id_nivel_usuario`) REFERENCES `nivel_acesso` (`id_nivel`);
COMMIT;
